...
export type InterestWhereInput = {
  ...
  interest_id?: Prisma.StringFilter<"Interest"> | string
  code?: Prisma.EnumInterestCodeFilter<"Interest"> | $Enums.InterestCode
  label?: Prisma.StringFilter<"Interest"> | string
  description?: Prisma.StringNullableFilter<"Interest"> | string | null
  is_active?: Prisma.BoolFilter<"Interest"> | boolean
  sort_order?: Prisma.IntFilter<"Interest"> | number
...
export type InterestScalarWhereWithAggregatesInput = {
  ...
  interest_id?: Prisma.StringWithAggregatesFilter<"Interest"> | string
  code?: Prisma.EnumInterestCodeWithAggregatesFilter<"Interest"> | $Enums.InterestCode
  label?: Prisma.StringWithAggregatesFilter<"Interest"> | string
  description?: Prisma.StringNullableWithAggregatesFilter<"Interest"> | string | null
  is_active?: Prisma.BoolWithAggregatesFilter<"Interest"> | boolean
  sort_order?: Prisma.IntWithAggregatesFilter<"Interest"> | number
...
export type InterestUpdateInput = {
  interest_id?: Prisma.StringFieldUpdateOperationsInput | string
  code?: Prisma.EnumInterestCodeFieldUpdateOperationsInput | $Enums.InterestCode
...
export type EnumInterestCodeFieldUpdateOperationsInput = {
  set?: $Enums.InterestCode
}
...
export type InterestOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"interest_id" | "code" | "label" | "description" | "is_active" | "sort_order" | "createdAt" | "updatedAt", ExtArgs["result"]["interest"]>
...
export interface InterestDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const interestWithInterest_idOnly = await prisma.interest.findMany({ select: { interest_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Interests and only return the `interest_id`
   * const interestWithInterest_idOnly = await prisma.interest.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Interests and only return the `interest_id`
   * const interestWithInterest_idOnly = await prisma.interest.updateManyAndReturn({
   *   select: { interest_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface InterestFieldRefs {
  readonly interest_id: Prisma.FieldRef<"Interest", 'String'>
  readonly code: Prisma.FieldRef<"Interest", 'InterestCode'>
  readonly label: Prisma.FieldRef<"Interest", 'String'>
  readonly description: Prisma.FieldRef<"Interest", 'String'>
  readonly is_active: Prisma.FieldRef<"Interest", 'Boolean'>
