...
export type PaymentWebhookEventWhereInput = {
  ...
  webhook_id?: Prisma.StringFilter<"PaymentWebhookEvent"> | string
  event?: Prisma.StringFilter<"PaymentWebhookEvent"> | string
  gateway_reference?: Prisma.StringNullableFilter<"PaymentWebhookEvent"> | string | null
...
export type PaymentWebhookEventOrderByWithRelationInput = {
  ...
  gateway_reference?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type PaymentWebhookEventScalarWhereWithAggregatesInput = {
  ...
  webhook_id?: Prisma.StringWithAggregatesFilter<"PaymentWebhookEvent"> | string
  event?: Prisma.StringWithAggregatesFilter<"PaymentWebhookEvent"> | string
  gateway_reference?: Prisma.StringNullableWithAggregatesFilter<"PaymentWebhookEvent"> | string | null
...
export type PaymentWebhookEventUpdateInput = {
  ...
  gateway_reference?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  payload?: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type PaymentWebhookEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"webhook_id" | "event" | "gateway_reference" | "payload" | "receivedAt", ExtArgs["result"]["paymentWebhookEvent"]>
...
export interface PaymentWebhookEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `webhook_id`
   * const paymentWebhookEventWithWebhook_idOnly = await prisma.paymentWebhookEvent.findMany({ select: { webhook_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PaymentWebhookEvents and only return the `webhook_id`
   * const paymentWebhookEventWithWebhook_idOnly = await prisma.paymentWebhookEvent.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more PaymentWebhookEvents and only return the `webhook_id`
   * const paymentWebhookEventWithWebhook_idOnly = await prisma.paymentWebhookEvent.updateManyAndReturn({
   *   select: { webhook_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PaymentWebhookEventFieldRefs {
  readonly webhook_id: Prisma.FieldRef<"PaymentWebhookEvent", 'String'>
  readonly event: Prisma.FieldRef<"PaymentWebhookEvent", 'String'>
  readonly gateway_reference: Prisma.FieldRef<"PaymentWebhookEvent", 'String'>
