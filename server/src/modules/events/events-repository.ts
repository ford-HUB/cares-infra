...
import { EventStatus, Prisma } from '../../infastructures/prisma/common/client';
import { PrismaService } from '../../infastructures/prisma/prisma-service';
import { PersistEventDto } from './events-dto';
...
export class EventsRepository {
    ...
    async updateDonations(
        id: number,
        donations: { funds_donation: boolean; goods_donation: boolean; goods_types: string[] },
    ) {
        return this.prisma.event.update({
            where: { event_id: id },
            data: donations,
    ...
    private toPrismaData(data: PersistEventDto): Prisma.EventCreateInput {
        return {
            ...
            geojson: (data.geojson ?? Prisma.DbNull) as Prisma.InputJsonValue,
