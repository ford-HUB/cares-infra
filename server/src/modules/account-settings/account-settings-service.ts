...
import { isPortalRole } from '../../common/constants/portal-role-types';
import {
    ChangeEmailDto,
...
export class AccountSettingsService {
    ...
    async changeEmail(
        ...
        const account = await this.accountSettingsRepository.findAccountByUserId(userId);
        ...
        const existing = await this.accountSettingsRepository.findAccountByEmail(newEmail);
        if (existing) {
    ...
    async changePassword(
        ...
        await this.accountSettingsRepository.updatePassword(account.account_id, hashedPassword);
